...
| Script | Función |
|--------|---------|
| `ssh-hardening.sh` | Hardening de SSH, deshabilita root, cifrados fuertes |
| `password-hardening.sh` | Políticas de contraseñas, lockout, hash SHA-512 |
| `selinux-secure-setup.sh` | Configura SELinux en modo permisivo (seguro) |
| `FS-hardening.sh` | Particiones separadas y opciones de montaje seguras |

[🔍 Ver todos los scripts de hardening →](https://github.com/OrangeBox-Labs/Linux-Hardening)
...
## Distribuciones y plataformas compatibles
